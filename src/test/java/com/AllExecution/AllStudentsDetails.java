...
.body(getFileContent("C:\\Users\\STBARIK\\eclipse-workspace\\STUDENTMANAGEMENT\\src\\test\\resources\\post.txt"))
...
{
RestAssured.given().baseUri("http://localhost:8082")
.body(getFileContent("C:\\Users\\STBARIK\\eclipse-workspace\\STUDENTMANAGEMENT\\src\\test\\resources\\put.txt"))
.header("Accept","application/json").header("Content-Type","application/json")
